...
分类，移除红沙配方，更新熔炉的合成材料为`#minecraft:stone_crafting_materials`；将猪灵蛮兵和监守者归类为敌对生物；移除岩浆块的合成；细雪桶支持倾倒；将深层矿石的产出较常规矿石提升了5%~
10%，最大产出不变；同步原版对溺尸、岩浆怪、兔子、史莱姆掉落物的修改；将告示牌配方的分组从`sign`修改为`wooden_sign`以同步原版；修改红树原木及其产物的合成
