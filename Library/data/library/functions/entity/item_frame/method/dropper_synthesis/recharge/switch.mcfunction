...
execute if entity @s[scores={libTemp=9}] if predicate library:dropper_synthesis/9x run function library:entity/item_frame/method/dropper_synthesis/recharge/9x
#execute if entity @s[scores={libTemp=8}] if predicate library:dropper_synthesis/8x run function library:entity/item_frame/method/dropper_synthesis/recharge/8x
#execute if entity @s[scores={libTemp=7}] if predicate library:dropper_synthesis/7x run function library:entity/item_frame/method/dropper_synthesis/recharge/7x
