...
# 改名，不会自然消失，必然掉装备
data merge entity @s {DeathLootTable:"library:entities/boss/zombie",HandDropChances:[1f,1f],ArmorDropChances:[1f,1f,1f,1f],CustomName:'{"translate":"entity.library.zombie.boss"}',CustomNameVisible:1b}
data merge entity @s[nbt={IsBaby:1b}] {CustomName:'{"translate":"entity.library.zombie.chara"}'}
# 主手
